...
<html>
 ...
 | Spline Plus documentation ">
  ...
  <div class="markdown level0 summary"><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="2">Provides methods for manipulating nodes in a SplinePlus object, including retrieving selected nodes, creating new nodes,
updating node positions, setting node positions, and chamfering nodes.</p>
</div>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Chamfer_SplinePlus_NodeModel_System_Single_" data-uid="ElseForty.splineplus.api.NodeAPI.Chamfer(SplinePlus,NodeModel,System.Single)">Chamfer(SplinePlus, NodeModel, float)</h4>
  <div class="markdown level1 summary"><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="2">Applies a chamfer effect to the specified node in the SplinePlus object, creating new nodes and branches as needed.</p>
</div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        <td><span class="xref">NodeModel</span></td>
        <td><span class="parametername">node</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The node to apply the chamfer effect to.</p>
</td>
      </tr>
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.single">float</a></td>
        <td><span class="parametername">value</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The value determining the extent of the chamfer effect.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="ElseForty_splineplus_api_NodeAPI_Collapse_" data-uid="ElseForty.splineplus.api.NodeAPI.Collapse*"></a>
  <h4 id="ElseForty_splineplus_api_NodeAPI_Collapse_SplinePlus_System_Collections_Generic_List_NodeModel__" data-uid="ElseForty.splineplus.api.NodeAPI.Collapse(SplinePlus,System.Collections.Generic.List{NodeModel})">Collapse(SplinePlus, List&lt;NodeModel&gt;)</h4>
  <div class="markdown level1 summary"><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="2">Connects the origin node with the target node in the specified spline, connecting their branches if necessary.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static void Collapse(SplinePlus splinePlus, List&lt;NodeModel&gt; nodes)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.collections.generic.list-1">List</a>&lt;<span class="xref">NodeModel</span>&gt;</td>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Compound_SplinePlus_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Compound(SplinePlus,NodeModel)">Compound(SplinePlus, NodeModel)</h4>
  ...
  <a id="ElseForty_splineplus_api_NodeAPI_Connect_" data-uid="ElseForty.splineplus.api.NodeAPI.Connect*"></a>
  <h4 id="ElseForty_splineplus_api_NodeAPI_Connect_SplinePlus_NodeModel_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Connect(SplinePlus,NodeModel,NodeModel)">Connect(SplinePlus, NodeModel, NodeModel)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static int Connect(SplinePlus splinePlus, NodeModel node1, NodeModel node2)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        <td><span class="xref">NodeModel</span></td>
        <td><span class="parametername">node1</span></td>
        <td></td>
      </tr>
      <tr>
        <td><span class="xref">NodeModel</span></td>
        <td><span class="parametername">node2</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Create_SplinePlus_Vector3_Vector3_Vector3_NodeType_Enum_" data-uid="ElseForty.splineplus.api.NodeAPI.Create(SplinePlus,Vector3,Vector3,Vector3,NodeType_Enum)">Create(SplinePlus, Vector3, Vector3, Vector3, NodeType_Enum)</h4>
  <div class="markdown level1 summary"><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="2">Creates a new node in the spline.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static NodeModel Create(SplinePlus splinePlus, Vector3 nodeWorldPos, Vector3 firstHandleLocalPos, Vector3 secondHandleLocalPos, NodeType_Enum nodeType = null)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><span class="xref">SplinePlus</span></td>
        <td><span class="parametername">splinePlus</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The SplinePlus component to which the node belongs.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">Vector3</span></td>
        <td><span class="parametername">nodeWorldPos</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The world position of the node.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">Vector3</span></td>
        <td><span class="parametername">firstHandleLocalPos</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The local position of the first handle relative to the node.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">Vector3</span></td>
        <td><span class="parametername">secondHandleLocalPos</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The local position of the second handle relative to the node.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">NodeType_Enum</span></td>
        <td><span class="parametername">nodeType</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The type of the node. Default is NodeType_Enum.Smooth.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">NodeModel</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The created NodeModel instance.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="markdown level1 summary"><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="2">Creates a new node in the specified spline.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static NodeModel Create(SplinePlus splinePlus, Vector3 nodeWorldPos)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><span class="xref">SplinePlus</span></td>
        <td><span class="parametername">splinePlus</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The spline to create the node in.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">Vector3</span></td>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">NodeModel</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The created node.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Delete_SplinePlus_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Delete(SplinePlus,NodeModel)">Delete(SplinePlus, NodeModel)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Diffuse_SplinePlus_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Diffuse(SplinePlus,NodeModel)">Diffuse(SplinePlus, NodeModel)</h4>
  ...
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static List&lt;NodeModel&gt; Diffuse(SplinePlus splinePlus, NodeModel node)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Duplicate_SplinePlus_NodeModel_System_Boolean_" data-uid="ElseForty.splineplus.api.NodeAPI.Duplicate(SplinePlus,NodeModel,System.Boolean)">Duplicate(SplinePlus, NodeModel, bool)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static NodeModel Duplicate(SplinePlus splinePlus, NodeModel originNode, bool copySharedNodeData = false)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><span class="parametername">copySharedNodeData</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_FlipHandles_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.FlipHandles(NodeModel)">FlipHandles(NodeModel)</h4>
  <div class="markdown level1 summary"><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="2">Creates a new node with flipped handles based on the provided node, doesn't change the node provided</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Connected_Branches_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Connected_Branches(NodeModel)">Get_Connected_Branches(NodeModel)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Handle_1_Position_NodeModel_SpaceType_Enum_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Handle_1_Position(NodeModel,SpaceType_Enum)">Get_Handle_1_Position(NodeModel, SpaceType_Enum)</h4>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        <td><span class="xref">SpaceType_Enum</span></td>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Handle_2_Position_NodeModel_SpaceType_Enum_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Handle_2_Position(NodeModel,SpaceType_Enum)">Get_Handle_2_Position(NodeModel, SpaceType_Enum)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Normal_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Normal(NodeModel)">Get_Normal(NodeModel)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Position_NodeModel_SpaceType_Enum_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Position(NodeModel,SpaceType_Enum)">Get_Position(NodeModel, SpaceType_Enum)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Scale_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Scale(NodeModel)">Get_Scale(NodeModel)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Speed_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Speed(NodeModel)">Get_Speed(NodeModel)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Get_Type_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Get_Type(NodeModel)">Get_Type(NodeModel)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Is_Shared_NodeModel_" data-uid="ElseForty.splineplus.api.NodeAPI.Is_Shared(NodeModel)">Is_Shared(NodeModel)</h4>
  ...
  <a id="ElseForty_splineplus_api_NodeAPI_Set_Handle_Position_" data-uid="ElseForty.splineplus.api.NodeAPI.Set_Handle_Position*"></a>
  <h4 id="ElseForty_splineplus_api_NodeAPI_Set_Handle_Position_NodeModel_Vector3_HandleType_Enum_SpaceType_Enum_" data-uid="ElseForty.splineplus.api.NodeAPI.Set_Handle_Position(NodeModel,Vector3,HandleType_Enum,SpaceType_Enum)">Set_Handle_Position(NodeModel, Vector3, HandleType_Enum, SpaceType_Enum)</h4>
  <div class="markdown level1 summary"><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="2">Sets the position of a handle on a node.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static void Set_Handle_Position(NodeModel node, Vector3 position, HandleType_Enum handleType, SpaceType_Enum spaceType)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><span class="xref">NodeModel</span></td>
        <td><span class="parametername">node</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The node to set the handle position on.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">Vector3</span></td>
        <td><span class="parametername">position</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The new position of the handle.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">HandleType_Enum</span></td>
        <td><span class="parametername">handleType</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The type of handle to set the position for.</p>
</td>
      </tr>
      <tr>
        <td><span class="xref">SpaceType_Enum</span></td>
        <td><span class="parametername">spaceType</span></td>
        <td><p sourcefile="api/ElseForty.splineplus.api.NodeAPI.yml" sourcestartlinenumber="1">The coordinate space to use for setting the position.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Set_Normal_SplinePlus_NodeModel_System_Single_" data-uid="ElseForty.splineplus.api.NodeAPI.Set_Normal(SplinePlus,NodeModel,System.Single)">Set_Normal(SplinePlus, NodeModel, float)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Set_Scale_NodeModel_System_Single_" data-uid="ElseForty.splineplus.api.NodeAPI.Set_Scale(NodeModel,System.Single)">Set_Scale(NodeModel, float)</h4>
  ...
  <a id="ElseForty_splineplus_api_NodeAPI_Set_TargetSpeed_" data-uid="ElseForty.splineplus.api.NodeAPI.Set_TargetSpeed*"></a>
  <h4 id="ElseForty_splineplus_api_NodeAPI_Set_TargetSpeed_NodeModel_System_Single_" data-uid="ElseForty.splineplus.api.NodeAPI.Set_TargetSpeed(NodeModel,System.Single)">Set_TargetSpeed(NodeModel, float)</h4>
  ...
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static void Set_TargetSpeed(NodeModel node, float speed)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Set_Type_NodeModel_NodeType_Enum_" data-uid="ElseForty.splineplus.api.NodeAPI.Set_Type(NodeModel,NodeType_Enum)">Set_Type(NodeModel, NodeType_Enum)</h4>
  ...
  <h4 id="ElseForty_splineplus_api_NodeAPI_Update_SplinePlus_NodeModel_System_Boolean_" data-uid="ElseForty.splineplus.api.NodeAPI.Update(SplinePlus,NodeModel,System.Boolean)">Update(SplinePlus, NodeModel, bool)</h4>
  ...
  <h5 class="declaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static void Update(SplinePlus splinePlus, NodeModel node, bool isProjection = false)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        <td><a class="xref" href="https://learn.microsoft.com/dotnet/api/system.boolean">bool</a></td>
        <td><span class="parametername">isProjection</span></td>
        <td></td>
      </tr>
    </tbody>
  </table>
